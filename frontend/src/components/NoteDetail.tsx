    ...
    return (
        <div className="p-4 max-w-xl mx-auto mt-8">
            {editMode ? (
                ...
                <>
                    <h1 className="text-2xl px-4 py-2 rounded-t-xl font-bold border-2 bg-blue-300">
                        {note.title}
                    </h1>
                    <p className="whitespace-pre-line rounded-b-xl px-4 py-2 border-l-2 border-b-2 border-r-2 bg-lime-300">
                        {note.content}
                    </p>
                    <div className="mt-4 flex gap-2">
                        <button
